<?php 
 ...
 $posts_count_drafted = xiu_fetch_one("select count(1) as num from posts where posts.status = 'drafted';")['num'];
 
 $comments_count_held = xiu_fetch_one('select count(1) as num from comments where comments.status = "held";')['num'];
 ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
